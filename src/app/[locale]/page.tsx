        ...
        <Container className="relative grid min-h-[calc(100vh-7.25rem)] items-center gap-12 py-14 sm:py-16 lg:grid-cols-[0.82fr_1.18fr] lg:py-20">
          <div className="max-w-3xl">
            ...
            <p className="mt-8 max-w-xl text-lg leading-9 text-ink-soft sm:text-xl sm:leading-10">
              {dictionary.home.subheading}
            </p>
            <div className="mt-11">
              <Button href={localizedPath(locale, '/shop')} className="bg-gold-deep text-cream hover:bg-caramel-deep">
      ...
      <Container>
        ...
        >
          <div className="grid gap-6 lg:grid-cols-3">
            {dictionary.home.experience.rituals.map(([number, title, description]) => (
              <article
                key={number}
      ...
      <section className="bg-white">
        <Container>
          <Section
            ...
            title={dictionary.home.collection.title}
            description={dictionary.home.collection.description}
          >
      ...
      <section className="bg-white">
        <Container>
          <Section
            ...
            title={dictionary.home.trustSection.title}
            description={dictionary.home.trustSection.description}
          >
            <div className="grid gap-4 md:grid-cols-3">
              {dictionary.home.trustSection.items.map((item) => (
                <div
                  key={item}
      ...
      <Container>
        <section className="py-20 text-center sm:py-24 lg:py-32">
          <p className="text-xs font-semibold uppercase tracking-[0.34em] text-honey">
            {dictionary.home.closing.eyebrow}
          </p>
